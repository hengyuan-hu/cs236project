...
parser.add_argument(
    ...
    type=int,
    default=20,
    help="diffusion sampling steps. more step (20~100 +) better quality, fewer steps (5-20) faster sampling",
)
...
for current_epoch in tqdm(range(10000)):
    ...
    with torch.no_grad():
        data = dataset.sample_diffusion(batchsize=args.batch_size, distance=4, device=device).obs
